...
## For Geopolitical Risk Dashboard

### Recommended Design Approach:

1. **Color Strategy:**
   - Primary: Deep Navy (#1a237e) - 专业、稳重
   - Risk High: Crimson (#b71c1c) - 危险、紧急
   - Risk Medium: Orange (#e65100) - 警告
   - Risk Low: Forest Green (#2e7d32) - 安全
   - Background: Off-white (#fafafa) or Dark mode (#0a0a0a)

2. **Typography:**
   - Heading: Inter or Geist (现代、清晰)
   - Body: Inter or system-ui
   - Monospace: JetBrains Mono (数据展示)

3. **Layout:**
   - Dashboard grid: 12-column system
   - Risk cards: Bento grid layout
   - Charts: Full-width with contained legends

4. **Artistic Tension:**
   - Use subtle gradients on risk indicators
   - Animated risk gauge (CSS/SVG animation)
