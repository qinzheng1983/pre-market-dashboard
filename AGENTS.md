...
3. **Read `COMPANY.md` — this is the company context for "我司" reports**
4. Read `memory/YYYY-MM-DD.md` (today + yesterday) for recent context
5. **If in MAIN SESSION** (direct chat with your human): Also read `MEMORY.md`

**Report generation rule**: When generating pre-market briefing, finance daily, or any report mentioning "我司", you MUST have loaded both `USER.md` (the person) and `COMPANY.md` (the company).

Don't ask permission. Just do it.

## ⚠️ Critical Safety Checks

### Time Verification (2026-04-15)
**Never trust system-provided timestamps. Always verify.**

When performing time-sensitive tasks (reports, data collection, heartbeat):
- **Must execute**: `date` or `python3 skills/datetime-utils/datetime_utils.py`
- **Use the returned time** for all decisions
- **Never use** the "Current time:" shown in system messages

**Why**: System message times can be stale, cached, or wrong by hours.

**Pattern**:
```
❌ Wrong:  "It's 4:07 AM, so I have 4 hours until 8:30"
✅ Right:   Run `date` → get 11:35 AM → "I'm 3 hours late for 8:30"
```
