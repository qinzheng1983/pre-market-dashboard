...
基于5层分析框架（V3.2 逻辑修正版）
修正内容：
1. 4.1 价格结构分析逻辑修正（出口商即期结汇更不划算）
2. 5.1 情景匹配执行点位修正（美元升值→USD/CNY上升；人民币升值→USD/CNY下降）
3. 5.2/5.3/5.4 删除已消除的北美出口敞口
4. 第二层投行观点更新为8月最新（中信证券/华泰证券/中金公司）
"""
...
DATA = {
    ...
    "DATA_CUTOFF": "2026年8月26日 11:00 CST",
    "RATING": "⭐⭐⭐⭐⭐（5星：关键数据当日+交叉验证+8月投行观点已更新）",
...
<div class="voice-item">
  <strong>【中信证券】</strong> 人民币兑美元汇率逼近2023年以来6.70高点，本轮升值的性质是<strong>定价权重的切换而非低估修复</strong>。当前存量待结汇资金规模可观，持汇的静态盈亏平衡线与动态成本线之间正是结汇意愿逐级放大的区间。从央行"汇率处于这些年来中值区间"的表态倒推，政策合意区间可能在6.6–7.0。<br>
  <span style="color:#888;">— 2026-08-23 | 方向：看涨人民币（USD/CNY 下行）| ✅ 近1周</span>
</div>
<div class="voice-item">
  <strong>【华泰证券】</strong> 美元因公信力挑战转弱、人民币升值强化，有助于港股AH溢价再度收窄。但本轮弱美元所处背景并非去年全球金融条件宽松和risk-on环境，流动性环境偏紧方向并未改变。8月央行年会是关注重点。<br>
  <span style="color:#888;">— 2026-08-24 | 方向：看涨人民币（USD/CNY 下行）| ✅ 近1周</span>
</div>
<div class="voice-item">
  <strong>【中金公司】</strong> 张文朗：降准降息仍在政策工具箱内，但需统筹银行净息差、<strong>人民币汇率</strong>和债券市场运行等多重因素。汇率是货币政策的约束条件之一。<br>
  <span style="color:#888;">— 2026-08-11 | 方向：中性偏紧（汇率约束货币政策空间）| ✅ 近2周</span>
</div>
<div class="voice-item">
  <strong>【高盛】</strong> 闪辉预测2026年底 USD/CNY 6.85，2027年底6.54，呈现持续温和升值趋势。核心逻辑：出口强劲、美元走弱、中美关系缓和。<br>
  <span style="color:#888;">— 2026-01-21 | 方向：看涨人民币（USD/CNY 下行）</span>
  <span style="color:#b7950b;">⚠️ 近7个月（年初展望，需结合最新数据修正）</span>
</div>
""",
...
""",
    ...
    "PRICE_GAP_ANALYSIS": (
        ...
        "<strong>若按中间价做内部核算，实际结汇收入比核算预期少657点</strong>。"
        "对于出口商（持有美元要结汇），银行买入价约6.7089，远低于中间价6.7852，"
        "实际结汇收入比中间价核算预期少约763点，<strong>即期结汇更不划算</strong>。"
        "对于进口商（需要美元购汇），银行卖出价约6.7372，低于中间价6.7852，"
        "按中间价做预算会<strong>高估成本</strong>约480点。"
        "央行维持这一差距的意图：① 引导贬值预期，防止人民币升值过快；"
        "② 鼓励出口商结汇（缩小即期-中间价差距的套利空间）；③ 为潜在放松预留空间。"
    ),
...
""",
  ...
  <tr><td>投行观点</td><td>2026-08</td><td>中信证券 / 华泰证券 / 中金公司</td><td>不定期</td><td>✅ 近1周–2周</td></tr>
  <tr><td>地缘风险</td><td>2026-08-20</td><td>财新 / 央视新闻 / 大公国际</td><td>实时</td><td>✅ 近1周</td></tr>
""",
    
    "VERSION_INFO": "V3.2 逻辑修正版 | 基于 indonesia-rupiah-scenario V3 五层框架改编 | 生成时间：2026-08-26 11:00 CST | 修正：4.1结汇逻辑/5.1执行点位/删除北美出口敞口/8月投行观点更新",
}
